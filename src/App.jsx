...
const handleDiscountCode = async (value) => {
  ...
  // Don't validate until code is at least 4 characters
...
const handleFileChange = async (event) => {
  try {
    ...
    // Process files quickly and ignore invalid ones
    const newPhotos = files.reduce((acc, file) => {
      // Quick validation
      ...
      // Valid file - create photo object
      validCount++;
      acc.push({
        id: uuidv4(),
        file: file,
    ...
    if (newPhotos.length > 0) {
      ...
      if (invalidCount > 0) {
        setError(t('warnings.invalid_files_skiped', {
